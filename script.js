...
legend.onAdd = function () {
    ...
    div.innerHTML = `
        ...
        <i style="background: #FF0000; width: 10px; height: 10px; display: inline-block;"></i> Rating < 2<br>
        <i style="background: #FFA500; width: 10px; height: 10px; display: inline-block;"></i> Rating 2-4<br>
        <i style="background: #008000; width: 10px; height: 10px; display: inline-block;"></i> Rating > 4<br>
        <i style="background: #808080; width: 10px; height: 10px; display: inline-block;"></i> No Rating
    `;
    div.style.backgroundColor = 'white';
    div.style.padding = '5px';
